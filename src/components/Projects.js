...
const projectsData = [
  {
    name: "Github Clone",
    description: "It was a fun project. After learning some basics of React.js I wanted to build something on my own, so I found the github API through which we can get the public data of a particular user.",
    image: githubImage,
    technologies: ["React.js", "Github API", "Context API", "Material-UI", "React-Router"],
    github : "https://github.com/Noor-Ansari/github-clone"
  },
  {
    name: "E-commerce App",
    description: "It is a very basic project in which I tried to replicate some minimal features of an e-commerce app, such as Add-to-cart/remove-from-cart, increasing/decreasing the items quantity and total-bill-amount.",
    image: shoppingImage,
  ...
  {
    name: "Quiz App",
    description: "It was the first web app I built using React. The app's structure is very simple it fetches the data from a json file according to the choosen category by user and then counts the right answers. At the end it shows the total score of the user.",
    image: quizImage,
  ...
  {
    name: "Weather App",
    description: "This app was built using flask and openweather API, which shows the weather information of the given city. The interface was designed using HTML and CSS.",
    image: weatherImage,
