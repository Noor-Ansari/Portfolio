...
const data = [
  { icon: instagram, link: "https://www.instagram.com/noor_coder/" },
  {
    icon: linkedin,
    link: "https://www.linkedin.com/in/noor-mohammad-0a28a21a3/",
  },
  { icon: github, link: "https://github.com/Noor-Ansari" },
  { icon: gmail },
];
